...
<body>
<div class="title">查询出库明细</div>
<div class="content">
    <form method="post" action="ckSelect.action" onsubmit="return check(this)">
        <div class="line">
        ...
        <div class="line">
            ...
            <div class="input-div"><input id="item3" list="select3" placeholder="请输入要查询的入库商户名称" name="placeName"/>
