...
<div class="content">
    <form method="post" action="addGoods" onsubmit="return check(this)">
        ...
        <div class="line">
            ...
            <div class="input-div"><input placeholder="请输入参考价值(只能输入数字和小数点)" name="goods.value" type="number"/> </div>
        </div>

        <div class="line">
            <div class="lable"><span>* </span>单价：</div>
            <div class="input-div">
            	<input id="price" placeholder="请输入单价(只能输入数字和小数点)" name="goods.price" type="number"/>
        ...
        <div class="line">
            ...
            <div class="input-div"><input placeholder="请输入长cm(只能输入数字和小数点)" name="goods.length" type="number"/></div>
        </div>

        <div class="line">
            <div class="lable">宽cm：</div>
            <div class="input-div"><input placeholder="请输入宽cm(只能输入数字和小数点)" name="goods.wide" type="number"/></div>
        </div>

        <div class="line">
            <div class="lable">高cm：</div>
            <div class="input-div"><input placeholder="请输入高cm(只能输入数字和小数点)" name="goods.tall" type="number"/></div>
        </div>

        <div class="line">
            <div class="lable">毛重kg：</div>
            <div class="input-div"><input placeholder="请输入毛重kg(只能输入数字和小数点)" name="goods.mweight" type="number"/></div>
        </div>

        <div class="line">
            <div class="lable">体积m*m*m：</div>
            <div class="input-div"><input placeholder="请输入体积m*m*m" name="goods.volume" type="number"/></div>
        </div>
        ...
        <div class="line">
            ...
            <div class="input-div">
            	<input id="creationDate" placeholder="请输入生产日期" name="goods.creationDate" type="date" onblur="calculate()"/>
            </div>
        </div>
